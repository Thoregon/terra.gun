...
import * as RindexedDB              from '../../gun/lib/rindexed.js';
...
export default class GunService extends Reporter(EventEmitter) {
    ...
    start() {
        ...
        const opts = { peers, localStorage: false, store: window.RindexedDB({}) };
        // if (store) {
        ...
        universe.$nowfn = () => new Date(window.Gun.state());
